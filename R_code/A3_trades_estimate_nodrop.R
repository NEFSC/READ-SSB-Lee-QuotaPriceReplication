...
Rda_out<-paste0("inter_prices_nodrop_FY_",vintage_string,".Rda")
csv_out<-paste0("inter_prices_nodrop_FY_",vintage_string,".csv")
...
Rda_out<-paste0("inter_prices_nodrop_qtr_",vintage_string,".Rda")
csv_out<-paste0("inter_prices_nodrop_qtr_",vintage_string,".csv")
dta_out<-paste0("inter_prices_nodrop_qtr_",vintage_string,".dta")
...
# Save the quarterly coefficients, 

save_out<-paste0("quarterly_estimation_results_nodrop_",vintage_string,".RData")
