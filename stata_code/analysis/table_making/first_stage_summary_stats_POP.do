...
label var interaction "Lease Only*totalpounds"
...
esttab . using ${my_tables}/first_stage_averages_POP.tex, `estab_opts_grand' addnotes("`price_line'" "`lease_line'")
pause


estpost tabstat `stats2', `estpost_opts_grand'
esttab .,   `estab_opts_grand_small'
esttab . using ${my_tables}/first_stage_averages_pr_inter_POP.tex, `estab_opts_grand_small'
...
esttab . using ${my_tables}/first_stage_averages_by_yr_POP.tex,`estab_opts_by' 
...
esttab . using ${my_tables}/first_stage_averages_by_yr_pr_inter_POP.tex,`estab_opts_by_small' 
