...
/*
This is just about identical to M03-explanatory_churdle.do. 
...
local mylogfile "${my_results}/M03B_churdleNB.smcl" 
...
local linear_hurdle ${my_results}/linear_hurdleB_noboot_${vintage_string}.ster
local log_indep_hurdle ${my_results}/log_indep_hurdleB_noboot_${vintage_string}.ster


local spatial_hurdle ${my_results}/spatial_hurdleB_noboot_${vintage_string}.ster

local exponential_hurdle ${my_results}/exponential_hurdleB_noboot_${vintage_string}.ster

local exponential_spatial_hurdle ${my_results}/exponential_spatial_hurdleB_noboot_${vintage_string}.ster
...
global exog_lev lnrecip ln_stock_QR_Index ln_stock_Nshannon_Q i.stock_distance_type#c.lnfp _Iq* 

global exog_part _Iq* lnrecip
...
global exog_lev lnrecip ln_stock_QR_Index  _Iq* 
global selection_controls  qrresid4
global level_controls  pres4 qrresid4
global exog_full $exog_part $exog_lev
global exog_full : list uniq global(exog_full)
...
global exog_lev lnrecip Wswt_ln_quota_remaining_BOQ Wswt_ln_livep  i.stock_distance_type#c.lnfp  _Iq*

global exog_part lnrecip _Iq* 
...
global exog_lev lnrecip Wswt_ln_quota_remaining_BOQ  i.stock_distance_type#c.lnfp  _Iq*
global exog_full $exog_part $exog_lev
global exog_full : list uniq global(exog_full)
...
global exog_lev lnrecip Wswt_ln_quota_remaining_BOQ _Iq*
global exog_full $exog_part $exog_lev
global exog_full : list uniq global(exog_full)
...
/* without the fuel price interactions */
global exog_lev Wswt_ln_quota_remaining_BOQ  lnrecip _Iq*
global exog_full $exog_part $exog_lev
global exog_full : list uniq global(exog_full)
...
/*********************************************************/
/*********************************************************/
/* Program  a softcoded version of the Exponential NEHURDLE with a control function */
/*********************************************************/
/*********************************************************/

cap program drop boot_nehurdle_exp_generic
program boot_nehurdle_exp_generic, rclass
	regress $endog1 $exog_full  $IVs
	predict pres4, residual
...
/* same as immediately above, but under exogeneity */
nehurdle badj_GDP $endog1 c.$endog2 $interaction $exog_lev, trunc exponential select(c.$endog2 $exog_part  $interaction)  vce(cluster clustvar)
...
nehurdle badj_GDP $endog1 c.$endog2 $interaction $exog_lev, trunc exponential select($exog_part c.$endog2 $interaction)  vce(cluster clustvar)
...
global exog_lev lnrecip ln_stock_QR_Index i.stock_distance_type#c.lnfp _Iq* 

/* perhaps try 
global exog_lev lnrecip ln_stock_QR_Index i(0 1).stock_distance_type#c.lnfp _Iq* 
...
global exog_lev lnrecip ln_stock_QR_Index c.lnfp _Iq* 
