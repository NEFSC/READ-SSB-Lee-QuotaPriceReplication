...
/*
Estimate the hurdle model, but exclude stocks where I don't estimate any prices in the first stage.
...
local mylogfile "${my_results}/M05-churdle_no_omitted_stocks_NB.smcl" 
...
local linear_hurdle ${my_results}/NOO_linear_hurdle4NB_${vintage_string}.ster
local log_indep_hurdle ${my_results}/NOO_log_indep_hurdle4NB_${vintage_string}.ster


local spatial_hurdle ${my_results}/NOO_spatial_hurdle4NB_${vintage_string}.ster

local exponential_hurdle ${my_results}/NOO_exponential_hurdle4NB_${vintage_string}.ster

local exponential_spatial_hurdle ${my_results}/NOO_exponential_spatial_hurdle4NB_${vintage_string}.ster
...
/* Old Way, this includes all stocks
...
This is a little tricky to explain/interpret, but I will put in 

(1): Y = a ln(quota_remaining_BOQ) + bln(fraction_remaining)

this is equivalent to 

(2): Y = c ln(quota_remaining_BOQ) + b ln(quota_remaining_BOQ) - b ln(ACL)

a=b+c

regress badj ln_quota_remaining_BOQ ln_fraction_remaining_BOQ

regress badj ln_quota_remaining_BOQ lnACL
nlcom _b[ln_quota_remaining_BOQ]+_b[lnACL]

Or, if I need to go from (2) to 1
