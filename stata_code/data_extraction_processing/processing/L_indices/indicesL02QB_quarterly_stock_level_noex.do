...
For all of the indices here, we INCLuDE stock i in the calculation of stock i's index .  See the line where we drop out the "own-stock" is commented out
...
local fishery_concentration ${data_main}/quarterly_stock_concentration_index_no_ex_${vintage_string}.dta
